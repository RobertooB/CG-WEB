<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default - Administrador.aspx.cs" Inherits="AplicativosIT._Default_" %>
    ...
    <link href="./Styles/DefaultStyles.css" rel="stylesheet" type="text/css" />
        <div style="position: relative">
            <div style="position: absolute; z-index: 2; width: 100%; height: 100%">
                ...
                <dx:ASPxButton ID="Button1" runat="server" Image-IconID="businessobjects_bo_department_svg_dark_32x32" AutoPostBack="False" UseSubmitBehavior="False" CssClass="botonLogin">
...
<Image IconID="arrows_next_svg_16x16"></Image>
                                ...
                                <Columns>
                                    ...
                                    <dx:CardViewComboBoxColumn Caption="Rol" FieldName="rol" ShowInCustomizationForm="True" VisibleIndex="4">
                                ...
                                <EditFormLayoutProperties>
                                    <Items>
                                        ...
                                        <dx:CardViewColumnLayoutItem ColSpan="1" ColumnName="rol">
                                        </dx:CardViewColumnLayoutItem>
